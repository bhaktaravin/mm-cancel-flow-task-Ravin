...
export default function StepOfferDeclined({ nextStep }: { nextStep: () => void }) {
  return (
      ...
      <div className="flex-1 flex flex-col justify-between p-6">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold mb-2 text-gray-900">
            All done, your <span className="bg-yellow-200 px-1 rounded">cancellation</span>&rsquo;s been processed.
          </h2>
          <p className="text-gray-700 mt-2">
            We&rsquo;re stoked to hear you&rsquo;ve landed a job and sorted your visa. Big congrats from the team <span role="img" aria-label="celebrate">🙌</span>
          </p>
        </div>
        {/* Button */}
        <button
