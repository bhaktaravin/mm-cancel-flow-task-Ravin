...
export default function StepWithoutMM({ form, setForm, nextStep, prevStep }: Props) {
  return (
    <div className="flex flex-col items-center text-center">
      <h2 className="text-xl font-bold mb-4 text-gray-900">Did you get a job without Migrate Mate?</h2>
