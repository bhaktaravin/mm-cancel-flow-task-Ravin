...
export default function ReasonNotEnoughJobsModal({
  form,
  setForm,
  nextStep,
  prevStep,
  ...
  const [feedback, setFeedback] = useState(form.notEnoughJobsFeedback ?? "");

  if (!isOpen) return null;

  const handleContinue = () => {
    setForm(f => ({ ...f, notEnoughJobsFeedback: feedback }));
    nextStep();
  };
    ...
    <div className="flex flex-row rounded-2xl bg-white p-10 min-w-[800px] max-w-[900px]">
      <div className="flex-1 pr-10 flex flex-col justify-center">
        ...
        <div className="flex items-center mb-4">
          ...
          <span className="font-medium text-lg">Not enough relevant jobs</span>
        </div>
