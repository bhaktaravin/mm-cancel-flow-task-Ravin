...
export default function ReasonTooExpensiveModal({
  form,
  setForm,
  nextStep,
  prevStep,
  ...
  const [maxPrice, setMaxPrice] = useState(form.tooExpensiveMaxPrice ?? "");

  if (!isOpen) return null;

  const handleContinue = () => {
    setForm(f => ({ ...f, tooExpensiveMaxPrice: maxPrice }));
    nextStep();
  };

  return (
    <div className="flex flex-row rounded-2xl bg-white p-10 min-w-[800px] max-w-[900px]">
      {/* Left: Content */}
      <div className="flex-1 pr-10 flex flex-col justify-center">
        ...
        <div className="flex items-center mb-4">
          ...
          <span className="font-medium text-lg">Too expensive</span>
        </div>
        <label htmlFor="maxPrice" className="text-gray-700 font-medium mb-2 block">
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            Get 50% off | $12.50 <span className="ml-2 text-gray-300 line-through text-base">$25</span>
          </button>
          <button
            className="bg-gray-200 text-gray-500 py-4 rounded-lg text-lg font-semibold"
            disabled
          >
      ...
      <div className="flex-1 flex items-center justify-center">
        <Image
          src="/main-image.png" // Replace with your actual image path if needed
          alt="Main"
          width={400}
          height={320}
