...
export default function StepVisaHelp({ form, setForm, nextStep, prevStep }: Props) {
  return (
    <div className="flex flex-col items-center text-center">
      <h2 className="text-xl font-bold mb-4 text-gray-900">Did you get help with visa?</h2>
